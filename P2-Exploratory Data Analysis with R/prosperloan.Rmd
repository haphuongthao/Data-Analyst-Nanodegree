...
This project is a part of [Data Analyst Nanodegree](https://udacity.com/course/data-analyst-nanodegree--nd002?v=a4) program.
...
# Load the Data
#setwd("~/DATA ANALYSIS/NANO DEGREE - DATA ANALYST/EDA/Final Project")
...
ggplot(prosper_loan %>% na.omit(ToIncomeRatio),
       aes(DebtToIncomeRatio))+
  geom_histogram(binwidth = 0.1, color = 'white')+
  coord_trans(xlim(0, quantile(prosper_loan$DebtToIncomeRatio, .99,
                               na.rm = TRUE)))+
  scale_x_log10()+
